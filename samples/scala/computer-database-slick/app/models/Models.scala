...
import play.api.db.slick.DB //import DB helper
import play.api.db.slick.Config.driver.simple._ //imports needed for current driver (chosen by reading the configuration file)
